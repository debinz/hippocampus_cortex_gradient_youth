...
%%% modified by zeng %% because 'SurfStatReadVol1' has error.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%vol=load_nii(template);  %vol=SurfStatReadVol1(template);                                                   %%
vol.data=template.img;                                                                                       %%
[nx,ny,nz]=size(template.img);  %[nx,ny,nz]=size(vol.data);                                                  %%
%if template.hdr.hist.qform_code>0                                                                            %%
    vol.origin    = [template.hdr.hist.qoffset_x template.hdr.hist.qoffset_y template.hdr.hist.qoffset_z];   %%
%else                                                                                                         %%
%    vol.origin    = [template.hdr.hist.srow_x(4) template.hdr.hist.srow_y(4) template.hdr.hist.srow_z(4)];   %%
%end                                                                                                          %%
vol.vox=[template.hdr.dime.pixdim(2) template.hdr.dime.pixdim(3) template.hdr.dime.pixdim(4)];                              %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
